...
def main(args) -> None:
    ...
    train_bad_loader = create_dataloader_from_directory(
        args.unlearning_dataset, tokenizer, args)
    train_normal_loader = create_dataloader_from_directory(
        args.normal_dataset, tokenizer, args)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=500,
        help="How many steps to save the model"
    )
    ...
    parser.add_argument('--normal_dataset',
                        type=str,
                        help="Path to directory of the normal dataset")
    parser.add_argument('--unlearning_dataset',
                        type=str,
                        help="Path to directory of the unlearning dataset")
    parser.add_argument("--one_per_file",
                        action="store_true",
                        help="Whether to use create only one chunk per file"
                        )
